        ...
        <div className="w-[92%] max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12 text-sm text-muted-foreground font-manrope leading-relaxed">
            ...
            <div id="creator-ownership" className="scroll-mt-28 space-y-3">
              ...
              <p>
                We believe in total creator sovereignty. When you design mockups, shader animations, wallpaper compositions, or social media graphics inside Plator:
              </p>
              <ul className="space-y-2 list-disc list-inside pl-1 text-foreground/90">
                <li>
                  <strong>100% Intellectual Property Ownership:</strong> You retain complete and exclusive ownership, copyright, and title to all graphic works, device mockups, compositions, and exported media generated by you using the Service.
                </li>
                <li>
